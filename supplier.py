...
class supplierClass:
    def __init__(self,root):
        ...
        #====title====
        title=Label(self.root,text="Supplier detials",font=("goudyoldstyle",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)


        #====content====
        lbl_supplier_invoice=Label(self.root,text="Invoice No.",font=("goudyoldstyle",15),bg="white").place(x=50,y=80)
        ...
        #====row2====
        lbl_name=Label(self.root,text="Name",font=("goudyoldstyle",15),bg="white").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120,width=180)
        

        #===row3====
        lbl_contact=Label(self.root,text="Contact",font=("goudyoldstyle",15),bg="white").place(x=50,y=160)
        ...
        #=====row4======
        lbl_desc=Label(self.root,text="Description ",font=("goudyoldstyle",15),bg="white").place(x=50,y=200)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Invoice No. already assigned,\n try different",parent=self.root)
                else:
