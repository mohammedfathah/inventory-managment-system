...
import os
import email_pass
import smtplib #pip install smtpli
import time
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By Mohammed Fathah | Webcode")
        ...
        title=Label(login_frame,text="Login Sytem",font=("Elephant",30,"bold"),bg="white").place(x=0,y=30,relwidth=1)
        ...
        lbl_pass=Label(login_frame,text="Passsword",font=("Andalus",15),bg="white",fg="#767171").place(x=50,y=200)
        txt_pass=Entry(login_frame,textvariable=self.password,show="*",font=("times new roman",15),bg="#ECECEC").place(x=50,y=240,width=250)

        btn_login=Button(login_frame,command=self.login,text="Log In",font=("Arial Rounded MT Bold",15),bg="#00B0F0",fg="white",activebackground="white",cursor="hand2").place(x=50,y=300,width=250,height=35)
        ...
        btn_signup=Button(register_frame,text="Sign Up",font=("times new roman",13,"bold"),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=200,y=20)
        ...
        try:
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    #call send email function()('mohammedfathahas@gmail.com')
                    ...
                    if chk=='f':
                        ...
                        lbl_new_pass_reset=Label(self.forget_win,text="New Password",font=("times new roman",15)).place(x=20,y=160)
                        txt_new_pass_reset=Entry(self.forget_win,textvariable=self.var_new_pass,font=("times new roman",15),bg="lightyellow").place(x=20,y=190,width=250,height=30)
                    
                        lbl_c_pass_reset=Label(self.forget_win,text="Confirm Password",font=("times new roman",15)).place(x=20,y=225)
                        txt_c_pass_reset=Entry(self.forget_win,textvariable=self.var_confirm_pass,font=("times new roman",15),bg="lightyellow").place(x=20,y=255,width=250,height=30)
