...
class salesClass:
    def __init__(self,root):
        ...
        #=====title==========
        lbl_title=Label(self.root,text="View Customer Bill",font=("goudy old style",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fil=X,padx=10,pady=20)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20),bg="orange").pack(side=TOP,fil=X)
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                print("yes find the invoice invoice")
                ...
                messagebox.showerror("Error","Innvalid Invice No.",parent=self.root)
    def clear(self):
        self.show()
        self.bill_area.delete('1.0',END)
