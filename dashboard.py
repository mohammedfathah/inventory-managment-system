...
class IMS:
    def __init__(self,root):
        ...
        self.lbl_sales.place(x=650,y=300,height=150,width=300)
         ...
         #===footer===
        lbl_footer=Label(self.root,text="IMS - Inventory management system | Developed by webcode \n For any Technical Issue contact: 89xxxxxx21",font=("times new roman",15),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#======================================================================================================================================================================
    ...
    def employee(self):
        self.neew_win=Toplevel(self.root)
        self.new_obj=employeeClass(self.neew_win)


    def supplier(self):
        self.neew_win=Toplevel(self.root)
        self.new_obj=supplierClass(self.neew_win)


    def category(self):
        self.neew_win=Toplevel(self.root)
        self.new_obj=categoryClass(self.neew_win)

    def product(self):
        self.neew_win=Toplevel(self.root)
        self.new_obj=productClass(self.neew_win)

    def sales(self):
        self.neew_win=Toplevel(self.root)
        self.new_obj=salesClass(self.neew_win)
