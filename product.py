...
class productClass:
    def __init__(self,root):
        ...
        #====title====
        title=Label(product_Frame,text="Manage Product detials",font=("goudyoldstyle",15),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)

        #===column1====

        lbl_category=Label(product_Frame,text="Category",font=("goundy old style",18),bg="white").place(x=30,y=60)
        lbl_supplier=Label(product_Frame,text="Supplier",font=("goundy old style",18),bg="white").place(x=30,y=110)
        lbl_product_name=Label(product_Frame,text="Name",font=("goundy old style",18),bg="white").place(x=30,y=160)
        lbl_price=Label(product_Frame,text="Price",font=("goundy old style",18),bg="white").place(x=30,y=210)
        lbl_quantity=Label(product_Frame,text="Quantity",font=("goundy old style",18),bg="white").place(x=30,y=260)
        lbl_status=Label(product_Frame,text="Status",font=("goundy old style",18),bg="white").place(x=30,y=310)
